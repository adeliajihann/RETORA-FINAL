@extends('tutor.layout.main', ['title'=>'Daftar Murid'])

@section('judul')
    <div class="pagetitle">
        <h1 >Daftar Murid (Diterima)</h1>
    </div><br>
@endsection
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#selesai{{ $data->id }}"><i class="bi bi-check-circle-fill"></i> Selesai</button>
                                <div class="modal fade" id="selesai{{ $data->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                        <form action="selesai/{{ $data->id }}" method="POST" cenctype="multipart/form-data">
                                            @csrf
                                            <input hidden type="text" name="tgl_akhir" id="tgl_akhir" class="form-control" value="{{ date("d/m/Y") }}" readonly>
                                            Apakah Anda yakin kegiatan les telah berakhir?</div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-light btn-sm" data-bs-dismiss="modal">Batal</button>
                                                <button type="submit" class="btn btn-primary btn-sm">Selesai</button></a>
                                            </div>
                                        </form>
                                    </div>
                                    </div>
