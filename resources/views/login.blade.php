          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              {{-- <div class="d-flex justify-content-center py-4">
                <i class="logo d-flex align-items-center w-auto">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <div style="text-align: left">
                      <a href="/" class="bi bi-house-door-fill"> Home</a>
                    </div>
                    <h5 class="card-title text-center pb-0 fs-4">Login</h5>
                  </div>

                  <form action="login/proses" method="POST" class="row g-3 needs-validation" novalidate>
                    @csrf
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        is-invalid
                        @enderror
                        " name="username" id="username" value="{{ old('username') }}" placeholder="Username..." required autofocus>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Belum punya akun? <a href="role">Buat akun baru</a></p>
                    </div>
                  </form>
                  <script>
