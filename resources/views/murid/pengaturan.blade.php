@extends('murid.layout.main', ['title'=>'Pengaturan Profil'])
            ...
            <div class="col-xl-4">
                <div class="card">
                    <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                        ...
                        @else 
                        <img src="{{ asset ('murid/img/'.$m->foto) }}" alt="Profile" class="rounded-circle" style="width: 120px; height: 120px;">
                        @endif
                        <h2>{{ $m->namaM }}</h2><br>
                        <div class="text-center">
                            <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#hapus{{ $m->id }}"><i class="bi bi-exclamation-circle"></i> Hapus Akun</button>
                    ...
                    <div class="card-body pt-3">
                        ...
                        <div class="tab-content pt-2">
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                ...
                                <p class="small fst">{{ $m->deskripsi }}</p>
                                <h5 class="card-title">Detail Profil</h5>
                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">Nama</div>
                                    <div class="col-lg-9 col-md-8">{{ $m->namaM }}</div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">Jenis Kelamin</div>
                                    <div class="col-lg-9 col-md-8">{{ $m->jk }}</div>
                                </div>                   
                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">Tanggal Lahir</div>
                                    <div class="col-lg-9 col-md-8">{{ $m->tgl_lahir }}</div>
                                </div>                   
                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">Alamat</div>
                                    <div class="col-lg-9 col-md-8">{{ $m->alamat }}</div>
                                </div>                   
                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">No Handphone</div>
                                    <div class="col-lg-9 col-md-8">{{ $m->no_hp }}</div>
                                </div>                  
                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">Pendidikan</div>
                                    <div class="col-lg-9 col-md-8">{{ $m->r_pendidikan }}</div>
                                </div>                  
                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">Kurikulum</div>
                                    <div class="col-lg-9 col-md-8">{{ $m->kurikulum }}</div>
                                </div>                  
                            </div>
                            <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                <form action="update/detail/murid/{{ $m->idM }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row mb-3">
                                        <div class="row mb-3">
                                            <label for="namaM" class="col-md-4 col-lg-3 col-form-label">Nama</label>
                                            <div class="col-md-8 col-lg-9">
                                                <input type="text" name="namaM" class="form-control
                                                @error('namaM')
                                                is-invalid
                                                @enderror
                                                " id="namaM" rows="3" value="{{ $m->namaM }}">
                                                @error('nama')
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                ...
                                                is-invalid
                                                @enderror
                                                " id="deskripsi" rows="3" value="{{ $m->deskripsi }}">
                                                @error('deskripsi')
                                                    <div class='invalid-feedback'>
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            is-invalid
                                            @enderror
                                            " id="r_pendidikan" value="{{ $m->r_pendidikan }}">
                                            @error('r_pendidikan')
                                                <div class='invalid-feedback'>
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="row mb-3">
                                            <label for="kurikulum" class="col-md-4 col-lg-3 col-form-label">Kurikulum</label>
                                            <div class="col-md-8 col-lg-9">
                                            <input name="kurikulum" type="text" class="form-control
                                            @error('kurikulum')
                                            is-invalid
                                            @enderror
                                            " id="kurikulum" value="{{ $m->kurikulum }}">
                                            @error('kurikulum')
                                                <div class='invalid-feedback'>
                                                    {{ $message }}
                                                </div>
                            ...
                            <div class="tab-pane fade profile-edit pt-3" id="change-photo-profile">
                                <form action="update/foto/murid/{{ $m->idM }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row mb-3">
                            ...
                            <div class="tab-pane fade pt-3" id="profile-change-password">
                                <form action="update/profil/murid/{{ $m->id }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row mb-3">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8 col-lg-11">
                                                ...
                                                is-invalid
                                                @enderror"
                                                name="email" id="email" value="{{ $m->email }}">
                                                @error('email')
                                                    <div class='invalid-feedback'>
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8 col-lg-11">
                                                ...
                                                is-invalid
                                                @enderror"
                                                name="username" id="username" value="{{ $m->username }}">
                                                @error('username')
                                                    <div class='invalid-feedback'>
                                                        {{ $message }}
                                                    </div>
                            ...
                            <div class="tab-pane fade pt-3" id="change-password">
                                <form action="update/password/murid/{{ $m->id }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row mb-3">
                                    <div class="form-group">
