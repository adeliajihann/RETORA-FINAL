...
<head>
  ...
  <title>Halaman Registrasi Tutor</title>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Daftar Akun Tutor</h5>
                  </div>

                  <form action="register-tutor" method="POST" class="row g-3 needs-validation" novalidate>
                    @csrf
                    <div class="col-12">
                      <label for="namaT" class="form-label">Nama</label><span class="text-danger">*</span>
                      <div class="input-group has-validation">
                        <input type="text" class="form-control
                        @error('namaT')
                        is-invalid
                        @enderror
                        " name="namaT" id="namaT" placeholder="Masukkan nama anda" value="{{ old('namaT') }}" required autofocus>
                    ...
                    <input hidden type="text" name="role" id="role" class="form-control" value="tutor">
