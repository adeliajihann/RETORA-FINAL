@extends('admin.layout.main', ['title'=>'Pengaduan Tutor'])
...
@section('isi')
  ...
  <div class="col-lg-15">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">Pengaduan Tutor</h5> 
          <table id="example" class="table table-borderless table-hover">
            <thead>
              <tr>
                <th style="text-align:center" scope="col">No</th>
                <th style="text-align:center" scope="col">Nama</th>
                <th style="text-align:center" scope="col">Pengaduan</th>
            ...
            @foreach($pengaduan as $data)
              <tr>
                ...
                <td style="text-align:center">{{ $data->pengaduan }}</td>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="respon/pengaduan/tutor/{{ $data->id }}" method="POST" cenctype="multipart/form-data">
                              @csrf
                              <div class="row g-3">
                                  <div class="col-12">
                      ...
                      <div class="modal-dialog">
                          <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                  ...
                                  <a href="hapus/pengaduan/tutor/{{ $data->id }}"><button type="button" class="btn btn-danger btn-sm">Hapus</button></a>
                              </div>
                          </div>
                      </div>
                  </div>
